...
int
IntegrityProtectionAlgorithms_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_IntegrityProtectionAlgorithms_constr_1 GCC_NOTUSED = {
